...
public class Organization implements Comparable<Organization> {
    ...
    public Organization(Integer id, String name, Coordinates coordinates, java.time.LocalDate creationDate, float annualTurnover, String fullName, Integer employeesCount, OrganizationType type, Address postalAddress) {
        this.id = id;
        this.name = name;
